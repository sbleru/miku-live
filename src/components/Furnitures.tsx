...
export function Mug(props: any) {
  const { nodes, materials }: any = useGLTF("/cup.glb");
  ...
  return (
    <group ref={cup as any} {...bind} dispose={null}>
...
export function Lamp(props: any) {
  ...
  useDistanceConstraint(fixed, lamp, {
    distance: 2 /**pivotA: [0, 0, 0], pivotB: [0, 2, 0]*/,
  });
